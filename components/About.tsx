  ...
  return (
    <div className='text-gray-400 py-8'>
        ...
        <p className='text-xl py-2'>
            ...
            <br />
            <br />
            Beyond web development, I enjoy solving LeetCode and data structures & algorithms problems to sharpen my problem-solving skills and write more efficient code. This logical approach helps me build optimized applications that perform well under real-world conditions.
            <br />
            <br />
